...
const page = ({ params }) => {
  ...
  const blogId = Number(unwrappedParams.id);
  ...
  useEffect(() => {
   ...
   <div className='mx-5 max-w-[450px] md:mx-auto mt-[-100px] mb-10'>
    ...
    <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum, accusamus rem impedit repellendus, amet similique minima labore, voluptate consequuntur nesciunt ratione corrupti. Officiis atque temporibus quos autem, sapiente voluptas iste.</p>
    <p className='my-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum, accusamus rem impedit repellendus, amet similique minima labore, voluptate consequuntur nesciunt ratione corrupti. Officiis atque temporibus quos autem, sapiente voluptas iste.</p>
    ...
    <div className='flex gap-2'>
      <Image src={assets.instagram_icon} width={24} alt=''/>
      <Image src={assets.facebook_icon} width={24} alt=''/>
      <Image src={assets.youtube_icon} width={24} alt=''/>
    </div>
